...
export default function KeyboardAware(){
  ...
  const scroolViewRef = useRef<KeyboardAwareScrollView | null>(null)
  const scrollToInput = (reactNode: any) => {
    scroolViewRef.current?.scrollToFocusedInput(reactNode)
  }
  ...
  return(
    <View style={[styles.view, {backgroundColor: colors.surface}]}>
      ...
      <KeyboardAwareScrollView ref={scroolViewRef} contentContainerStyle={[styles.flex]}>
